...
func AddScorer(ctx context.Context, engine *gin.Engine, scorer score.Scorer) {
...
func cacheResponse(response *score.PromptScore, promptCache *cache.InMemoryCache, prompt string) {
